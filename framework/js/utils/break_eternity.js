...
class Decimal {
    ...
    static affordGeometricSeries_core(resourcesAvailable, priceStart, priceRatio, currentOwned) {
        ...
        return Decimal.floor(resourcesAvailable
            .div(actualStart)
            ...
            while (stage < 4) {
                ...
                while (upper.neq(lower)) {
                    ...
                    if (upper.pow10().recip().tetrate(degree, 1, true).eq(1) && upper.pow10().recip().lt(0.4)) {
                        ...
                        if (stage == 1 && (nextPoint.tetrate(degree, 1, true).gt(upperBound.tetrate(degree, 1, true)) && prevPoint.tetrate(degree, 1, true).gt(upperBound.tetrate(degree, 1, true)))
                            ||
